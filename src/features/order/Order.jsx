...
function Order() {
  ...
  return (
    <div className="spacey-8 px-4 py-6">
      <div className="flex-rap flex items-center justify-between gap-2">
      ...
      <div className="flex-rap flex items-center justify-between gap-2 bg-stone-200 px-6 py-5">
